...
class DataLoader:
    ...
    def load_data(self, pub_only=False):
        ...
        # load public data
        logger.info(f"reading public data from {config['pub_dataset_path']}")
        self.public_data = pd.read_csv(config['pub_dataset_path'], dtype=COLS)
        ...
        # load private data
        logger.info(f"reading private data from {config['priv_dataset_path']}")
        self.private_data = pd.read_csv(config['priv_dataset_path'], dtype=COLS)
